...
%start by providing information and parameters
    ...
    info.parameters = [...
        ...
        Parameter('shortCaption','nCompPLSR','value',int32(19), 'enum',int32(1:20), 'selectionType','multiple'),...
        Parameter('shortCaption','criterion','value','Elbow','enum',{'Elbow','Min', 'MinOneStd', 'All'}),...
...
%     end
    ...
    [rank, numFeat, error, beta0, offset, projectedData] = rankByMethod(data,params,method);
...
function [rank, numFeat, error, beta0, offset, projectedData]  = rankByMethod(data,params,method)
